...
@testset ExtendedTestSet "Patterns" begin
    ...
    @testset "Preface Checks" begin
        ...
        @test repr(prefix1.code) == "JLpeg.Instruction[JLpeg.ChoiceInst(5, 0xffff, 0xff, JLpeg.IChoice), JLpeg.CharInst('a', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('b', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('c', 0xffff, 0xff, JLpeg.IChar), JLpeg.LabelInst(9, 0xffff, 0xff, JLpeg.ICommit), JLpeg.ChoiceInst(5, 0xffff, 0xff, JLpeg.IChoice), JLpeg.CharInst('a', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('b', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('d', 0xffff, 0xff, JLpeg.IChar), JLpeg.LabelInst(4, 0xffff, 0xff, JLpeg.ICommit), JLpeg.CharInst('a', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('b', 0xffff, 0xff, JLpeg.IChar), JLpeg.CharInst('f', 0xffff, 0xff, JLpeg.IChar), JLpeg.MereInst(0xffffffff, 0xffff, 0xff, JLpeg.IEnd)]"
